...
function DashboardOverview() {
    ...
    const [primaryVehicle, setPrimaryVehicle] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardOverview.useEffect": ()=>{
            const loadData = {
                "DashboardOverview.useEffect.loadData": async ()=>{
                    try {
                        const userRes = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthService"].getCurrentUser();
                        if (userRes.data) {
                            setUser(userRes.data);
                            // Load role-specific data
                            if (userRes.data.role === 'car_owner') {
                                const vehiclesRes = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VehicleService"].getVehicles().catch({
                                    "DashboardOverview.useEffect.loadData": ()=>({
                                            data: []
                                        })
                                }["DashboardOverview.useEffect.loadData"]);
                                if (vehiclesRes.data) {
                                    ...
                                    const primary = vehiclesList.find({
                                        "DashboardOverview.useEffect.loadData.primary": (v)=>v.is_primary
                                    }["DashboardOverview.useEffect.loadData.primary"]);
                                    if (primary) setPrimaryVehicle(primary);
                                }
                            } else if (userRes.data.role === 'shop_owner') {
                                // Check if shop is set up
                                const shopRes = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$shops$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShopService"].getMyShop().catch({
                                    "DashboardOverview.useEffect.loadData": ()=>({
                                            data: {
                                                shop: null
                                            }
                                ...
                                if (shopRes.data?.shop) {
                                    ...
                                    const leadsRes = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$shops$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShopService"].getLeads().catch({
                                        "DashboardOverview.useEffect.loadData": ()=>({
                                                data: {
                                                    leads: []
                                                }
    ...
    if (user?.role === 'shop_owner') {
        ...
        if (!shop) {
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ShopSetupPrompt, {
                user: user
            }, void 0, false, {
                fileName: "[project]/app/dashboard/page.tsx",
                lineNumber: 74,
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(RepairShopDashboard, {
            user: user,
            leads: leads,
            shop: shop
        }, void 0, false, {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ConsumerDashboard, {
        user: user,
        vehicles: vehicles,
...
_s(DashboardOverview, "pXD/gRTXiHYwPg0IqDEaFvMwta4=");
...
function RepairShopDashboard({ user, leads, shop }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    shop.verification_status === 'approved' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            urgentLeads.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    lead.urgency === 'high' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_c3 = RepairShopDashboard;
var _c, _c1, _c2, _c3;
__turbopack_context__.k.register(_c, "DashboardOverview");
__turbopack_context__.k.register(_c1, "ConsumerDashboard");
__turbopack_context__.k.register(_c2, "ShopSetupPrompt");
__turbopack_context__.k.register(_c3, "RepairShopDashboard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_79c0747b._.js.map